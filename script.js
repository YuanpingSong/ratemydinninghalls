...
const context_button = document.querySelector('button');
...
const context_all = 2;
let flex_container_context = context_halls;
...
context_button.addEventListener('click', context_button_on_click);
